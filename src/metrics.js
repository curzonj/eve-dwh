...
bluebird.try(function() {
    ...
    return sql("metric_observations").where({ hostname: hostname, proc_type: proc_type }).delete()
}).then(function() {
    ...
    setInterval(function() {
        ...
        sql("metric_observations").where({ hostname: hostname, proc_type: proc_type }).update({
            updated_at: sql.raw("current_timestamp"),
            metrics: data
        }).then(function() {
